      ...
      <div>
        <header className="w-screen ">
          <div className="2xl:max-w-[1440px] 2xl:mx-auto w-full absolute top-0 left-0 right-0 py-5 px-4 md:px-24 text-white flex justify-between items-center">
            <div className="logo">
              <Link href="/">
                <p className="cursor-pointer text-4xl font-medium ">Voyager</p>
              </Link>
            </div>
            <div className="text-md font-medium flex flex-col md:flex-row justify-between md:items-center md:space-x-12 ">
              ...
              <Link href="#popular-destinations">
                <p className="cursor-pointer ">Popular Destinations</p>
              </Link>
              <Link href="#accomodations">
                <p className="cursor-pointer ">Accomodations</p>
              </Link>
              <Link href="/register">
        ...
        <section id="popular-destinations" className="">
          <div className="2xl:max-w-[1441px] 2xl:mx-auto pl-4 md:pl-24 mt-12">
            <p className="heading ">Featured Destinations</p>
            <p className="text-lg text-gray-900 mt-5 mb-14">
              Tired of the same super crowded spots?
              <br />
              Here you&apos;ll find unique travel destinations around the world!
              <br />
              Only truly amazing destinations to inspire your next trip.
            </p>
          </div>
          <div className="px-6 pb-6 space-x-12 flex items-start justify-begin overflow-x-hidden">
            {cards.slice(0, 5).map((card: CardsType, ind) => (
              <Cards {...card} key={ind} />
            ))}
          </div>
        </section>
        ...
        >
          ...
          <p className="text-lg text-gray-900 text-black mt-5 mb-14">
            Voyager can help you get started with talking that first trip to a
            new place.
            <br />
            Sign up for our recommended destinations newsletter and receive new
            <br />
        ...
        <footer className="bg-[#001638]">
          <div className="2xl:max-w-[1441px] 2xl:mx-auto px-4 md:pl-24 lg:pl-[350px] pt-12 pb-16">
            <p className="heading text-white ">About us</p>
            <ul className="text-lg text-white mt-10 space-y-5 ">
              <li className="cursor-pointer">About</li>
              <li className="cursor-pointer">Team</li>
              <li className="cursor-pointer">Contact us</li>
            </ul>
            <p className="text-lg text-white mt-24">© Voyager 2022</p>
          </div>
        </footer>
      </div>
    </div>
  ...
  return (
    <div className="w-[350px] min-w-[350px] shadow-[0px_8px_24px_rgba(149,157,165,0.2)] ">
      ...
      <div className="w-full h-fit pt-5 px-5 ">
        ...
        <p className="description my-5 ">{data.text}</p>
      </div>
    </div>
  )
}
